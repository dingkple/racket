...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ps01-snacks-tests) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require rackunit)
(require "extras.rkt")
