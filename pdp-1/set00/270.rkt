...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |270|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require 2htdp/image)
...
(define (draw_strings slst)
  (text/font (get_whole_string slst) 18 "indigo" #f 'roman 'normal 'normal #f))
